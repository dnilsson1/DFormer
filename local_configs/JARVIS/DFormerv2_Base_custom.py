...
# REDUCED RANGE to prevent overfitting (was 0.02-20, now 0.1-5.0)
# Using sqrt of inverse frequency for gentler rebalancing
C.focal_alpha = [
    0.10,   # 0: battery (71.24%) - downweight but not too aggressively
    ...
    5.00,   # 17: screw (0.06%) - rarest class (was 20, now 5)
    0.55,   # 18: tube (3.42%)
]
...
C.bn_eps = 1e-3
C.bn_momentum = 0.1
C.drop_path_rate = 0.2  # Increased from 0.1 for more regularization to prevent overfitting
C.aux_rate = 0.0
...
"""Store Config"""
C.checkpoint_start_epoch = 10  # Start saving at epoch 10 (was 20)
